...
def generate_sql_query(
    ...
    try:
        ...
        logger.error(
            f"Error generating questions for user_message '{user_message}': {e}"
        )
        raise
...
def generate_question_answer(
    user_question: str, sql_query: str, sql_result: str
) -> str:
...
def handle_user_message(user_question):
    ...
    final_resposne = generate_question_answer(
        user_question=user_question, sql_query=sql_query, sql_result=sql_result
    )
